...
public class Cache {
    ...
    public static final Map<String, ViewSelector> selectorCache = new HashMap<>();
    public static final Map<String, BiMap<String, EObject>> perSelectorUuidToEObjectMapping = new HashMap<>();
